...
<template>
  ...
  >
    <div class="">
      <h1 class="font-bold text-2xl md:text-3xl flex flex-row gap-5 items-center"><i class="pi pi-briefcase"></i> Work Experience</h1>
      <h1></h1>
    </div>
    <div
  ...
  >
    <div class="">
      <h1 class="font-bold text-2xl md:text-3xl flex flex-row gap-5 items-center"><i class="pi pi-graduation-cap"></i> Education</h1>
      <h1></h1>
    </div>
    <div
